...
class SliderController extends ControllerBase {
  ...
  public function gavias_sl_sliders_list($gid){
    ...
    foreach ($results as $row) {
      ...
      $tmp[] = $row->id;
      $tmp[] = $row->title;
      $tmp[] = t('<a href="@link_2">Edit Silder</a> | <a href="@link_3">Delete</a>', array(
          '@link_2' => \Drupal::url('gavias_sl_sliders.admin.form', array('sid' => $row->id, 'gid' => $gid)),
  ...
  public function gavias_sl_sliders_edit($gid=0, $sid=0) {
    ...
    $page['#attached']['drupalSettings']['gavias_sliderlayer']['group_settings'] = $group_settings;
