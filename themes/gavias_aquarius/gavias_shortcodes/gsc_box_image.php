           ...
           'type'          => 'gsc_box_image',
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'type'      => 'text',
                  'title'     => 'Icon',
                  'desc'     => t('Use class icon font <a href="http://fontawesome.io/icons/">Icon Awesome</a> or <a class="'.base_path().'/'.drupal_get_path('theme', 'gavias_aquarius').'/demo-font/index.html'.'">Custom icon</a>'),
               ),
               array(
                  'id'        => 'link',
                  'type'      => 'text',
