         ...
         $fields = array(
            ...
            'fields' => array(
               ...
               array(
                  ...
                  'type'      => 'text',
                  'std'       => 'fa fa-thumbs-up',
                  'desc'     => t('Use class icon font <a target="_blank" href="http://fontawesome.io/icons/">Icon Awesome</a> or <a target="_blank" href="'.base_path().'/'.drupal_get_path('theme', 'gavias_aquarius').'/demo-font/index.html'.'">Custom icon</a>'),
               ),
               array(
                  'id'        => 'number',
                  'title'     => t('Number'),
