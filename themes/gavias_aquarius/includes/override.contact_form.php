<?php
function gavias_aquarius_form_contact_message_feedback_form_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id) {
...
function gavias_aquarius_form_contact_message_register_free_course_form_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id) {

  // Name
  $form['name']['#weight'] = -1;
  $form['name']['#prefix'] = '<div class="contact-register"><div class="clearfix"><div class="form-group">';
  $form['name']['#suffix'] = '</div></div>';
  $form['name']['#attributes']['placeholder'][] = $form['name']['#title'].'*';
  $form['name']['#attributes']['class'][] = 'form-control';
  unset($form['name']['#title']);
  ...
  // Mail
  $form['mail']['#weight'] = -2;
  $form['mail']['#prefix'] = '<div class="clearfix"><div class="form-group">';
  $form['mail']['#suffix'] = '</div></div>';
  $form['mail']['#attributes']['placeholder'][] = $form['mail']['#title'].'*';
  $form['mail']['#attributes']['class'][] = 'form-control';
  unset($form['mail']['#title']);
  ...
  // Subject
  $form['subject']['widget'][0]['#weight'] = -3;
  $form['subject']['widget'][0]['#prefix'] = '<div class="clearfix"><div class="form-group">';
